...
import '../pages/laundry_employee/tabs/employee_settings_tab.dart' as _i26;
...
import '../pages/laundry_employee/tabs/laundry_employee_repair_events_tab.dart'
    as _i21;
import '../pages/laundry_employee/tabs/laundry_employee_statistic.dart' as _i22;
...
import '../pages/laundry_employee/tabs/laundry_settings_tab.dart' as _i23;
...
class AppAutoRouter extends _i27.RootStackRouter {
  AppAutoRouter([_i28.GlobalKey<_i28.NavigatorState>? navigatorKey])
      : super(navigatorKey);
  ...
  final Map<String, _i27.PageFactory> pagesMap = {
    ...
    LaundryEventsRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i19.LaundryEmployeeEventsTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
    ...
    LaundryAllModesRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i20.LaundryEmployeeAllModesTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
    ...
    LaundryRepairEventsRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i21.LaundryEmployeeRepairEventsTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
    ...
    LaundryStatisticRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i22.LaundryEmployeeStatisticTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
    ...
    LaundrySettingsRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i23.LaundrySettingsTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
    ...
    AdditionalModesRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i25.AdditionalModesTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
    ...
    EmployeeSettingsRoute.name: (routeData) {
      return _i27.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i26.EmployeeSettingsTab(),
          transitionsBuilder: _i27.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 250,
          opaque: true,
          barrierDismissible: false);
  ...
  List<_i27.RouteConfig> get routes => [
        ...
        _i27.RouteConfig(SplashRoute.name, path: '/init'),
        _i27.RouteConfig(LoginRoute.name, path: '/auth/login'),
        _i27.RouteConfig(RestorePasswordRoute.name, path: '/auth/restore'),
        _i27.RouteConfig(AdminRoute.name, path: '/admin/', children: [
          _i27.RouteConfig('#redirect',
              path: '',
              parent: AdminRoute.name,
              redirectTo: 'laundries/',
              fullMatch: true),
          _i27.RouteConfig(AdminLaundriesRoute.name,
              path: 'laundries/', parent: AdminRoute.name),
          _i27.RouteConfig(AdminBackupsRoute.name,
              path: 'backups/', parent: AdminRoute.name),
          _i27.RouteConfig(AdminClientsRoute.name,
              path: 'clients/', parent: AdminRoute.name),
          _i27.RouteConfig(AdminStatisticRoute.name,
              path: 'statistic/', parent: AdminRoute.name),
          _i27.RouteConfig(AdminSettingsRoute.name,
              path: 'settings/', parent: AdminRoute.name),
          _i27.RouteConfig(AdminRepairCompaniesRoute.name,
              path: 'repairCompanies/', parent: AdminRoute.name)
        ]),
        _i27.RouteConfig(AdminLaundryRoute.name,
            ...
            children: [
              _i27.RouteConfig('#redirect',
                  ...
                  fullMatch: true),
              _i27.RouteConfig(AdminWashMachinesRoute.name,
                  path: 'washMachines/', parent: AdminLaundryRoute.name),
              _i27.RouteConfig(AdminEmployeesRoute.name,
                  path: 'employees/', parent: AdminLaundryRoute.name)
            ]),
        _i27.RouteConfig(LaundryRoute.name, path: '/laundry/', children: [
          _i27.RouteConfig('#redirect',
              path: '',
              parent: LaundryRoute.name,
              redirectTo: 'washingMachines/',
              fullMatch: true),
          _i27.RouteConfig(LaundryWashMachinesRoute.name,
              path: 'washingMachines/', parent: LaundryRoute.name),
          _i27.RouteConfig(LaundryEmployeesRoute.name,
              path: 'employees/', parent: LaundryRoute.name),
          _i27.RouteConfig(LaundryEventsRoute.name,
              path: 'events/', parent: LaundryRoute.name),
          _i27.RouteConfig(LaundryAllModesRoute.name,
              path: 'allModes/',
              parent: LaundryRoute.name,
              children: [
                _i27.RouteConfig('#redirect',
                    ...
                    redirectTo: 'modes/',
                    fullMatch: true),
                _i27.RouteConfig(ModesRoute.name,
                    path: 'modes/', parent: LaundryAllModesRoute.name),
                _i27.RouteConfig(AdditionalModesRoute.name,
                    path: 'additionalModes/', parent: LaundryAllModesRoute.name)
              ]),
          _i27.RouteConfig(LaundryRepairEventsRoute.name,
              path: 'repairEvents/', parent: LaundryRoute.name),
          _i27.RouteConfig(LaundryStatisticRoute.name,
              path: 'statistic/', parent: LaundryRoute.name),
          _i27.RouteConfig(LaundrySettingsRoute.name,
              path: 'settings/', parent: LaundryRoute.name)
        ]),
        _i27.RouteConfig(EmployeeRoute.name, path: '/employee/', children: [
          _i27.RouteConfig('#redirect',
              path: '',
              parent: EmployeeRoute.name,
              redirectTo: 'washingMachines/',
              fullMatch: true),
          _i27.RouteConfig(EmployeeWashMachinesRoute.name,
              path: 'washingMachines/', parent: EmployeeRoute.name),
          _i27.RouteConfig(EmployeeEventsRoute.name,
              path: 'events/', parent: EmployeeRoute.name),
          _i27.RouteConfig(EmployeeAllModesRoute.name,
              path: 'allModes/',
              parent: EmployeeRoute.name,
              children: [
                _i27.RouteConfig('#redirect',
          ...
          _i27.RouteConfig(EmployeeRepairEventsRoute.name,
              path: 'repairEvents/', parent: EmployeeRoute.name),
          _i27.RouteConfig(EmployeeStatisticRoute.name,
              path: 'statistic/', parent: EmployeeRoute.name),
          _i27.RouteConfig(EmployeeSettingsRoute.name,
              path: 'settings/', parent: EmployeeRoute.name)
        ]),
        _i27.RouteConfig(RepairCompanyMainRoute.name, path: '/repairCompany/')
      ];
}
...
class RestorePasswordRoute extends _i27.PageRouteInfo<void> {
...
class AdminLaundryRoute extends _i27.PageRouteInfo<AdminLaundryRouteArgs> {
  AdminLaundryRoute(
      {_i28.Key? key,
...
/// generated route for
/// [_i6.LaundryPage]
class LaundryRoute extends _i27.PageRouteInfo<void> {
  const LaundryRoute({List<_i27.PageRouteInfo>? children})
...
/// generated route for
/// [_i7.EmployeePage]
class EmployeeRoute extends _i27.PageRouteInfo<void> {
  const EmployeeRoute({List<_i27.PageRouteInfo>? children})
...
class RepairCompanyMainRoute extends _i27.PageRouteInfo<void> {
...
class AdminLaundriesRoute extends _i27.PageRouteInfo<void> {
...
class AdminBackupsRoute extends _i27.PageRouteInfo<void> {
...
class AdminClientsRoute extends _i27.PageRouteInfo<void> {
...
class AdminStatisticRoute extends _i27.PageRouteInfo<void> {
...
class AdminSettingsRoute extends _i27.PageRouteInfo<void> {
...
class AdminRepairCompaniesRoute extends _i27.PageRouteInfo<void> {
...
class AdminWashMachinesRoute extends _i27.PageRouteInfo<void> {
...
class AdminEmployeesRoute extends _i27.PageRouteInfo<void> {
...
class LaundryWashMachinesRoute extends _i27.PageRouteInfo<void> {
...
class LaundryEmployeesRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i19.LaundryEmployeeEventsTab]
class LaundryEventsRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i20.LaundryEmployeeAllModesTab]
class LaundryAllModesRoute extends _i27.PageRouteInfo<void> {
  const LaundryAllModesRoute({List<_i27.PageRouteInfo>? children})
...
/// generated route for
/// [_i21.LaundryEmployeeRepairEventsTab]
class LaundryRepairEventsRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.LaundryEmployeeStatisticTab]
class LaundryStatisticRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i23.LaundrySettingsTab]
class LaundrySettingsRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.ModesTab]
class ModesRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i25.AdditionalModesTab]
class AdditionalModesRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i17.LaundryEmployeeWashMachinesTab]
class EmployeeWashMachinesRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i19.LaundryEmployeeEventsTab]
class EmployeeEventsRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i20.LaundryEmployeeAllModesTab]
class EmployeeAllModesRoute extends _i27.PageRouteInfo<void> {
  const EmployeeAllModesRoute({List<_i27.PageRouteInfo>? children})
...
/// generated route for
/// [_i21.LaundryEmployeeRepairEventsTab]
class EmployeeRepairEventsRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.LaundryEmployeeStatisticTab]
class EmployeeStatisticRoute extends _i27.PageRouteInfo<void> {
...
/// generated route for
/// [_i26.EmployeeSettingsTab]
class EmployeeSettingsRoute extends _i27.PageRouteInfo<void> {
