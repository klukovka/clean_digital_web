...
import '../bloc/auth/login_page/login_page_cubit.dart' as _i23;
...
import '../services/backup_service.dart' as _i22;
...
import '../services/repair_companies_service.dart' as _i15;
import '../services/statistic_service.dart' as _i16;
import 'module/api_module.dart' as _i31; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i15.RepairCompaniesService>(
      () => _i15.RepairCompaniesService(get<_i11.CleanDigitalApiClient>()));
  gh.factory<_i16.StatisticService>(
      () => _i16.StatisticService(get<_i11.CleanDigitalApiClient>()));
  gh.factoryParam<_i17.AdminLaundryPageCubit, String?, dynamic>(
      (laundryId, _) =>
          _i17.AdminLaundryPageCubit(get<_i13.LaundriesService>(), laundryId));
  gh.factoryParam<_i18.AdminRepairProductsViewCubit, String?, dynamic>(
      (companyId, _) => _i18.AdminRepairProductsViewCubit(
          get<_i15.RepairCompaniesService>(), companyId));
  gh.factory<_i19.AdminStatisticTabCubit>(
      () => _i19.AdminStatisticTabCubit(get<_i16.StatisticService>()));
  gh.factoryParam<_i20.AdminWashMachinesTabCubit, String?, dynamic>((laundryId,
          _) =>
      _i20.AdminWashMachinesTabCubit(get<_i13.LaundriesService>(), laundryId));
  gh.factory<_i21.AuthService>(
      () => _i21.AuthService(get<_i11.CleanDigitalApiClient>()));
  gh.factory<_i22.BackupService>(
      () => _i22.BackupService(get<_i11.CleanDigitalApiClient>()));
  gh.factory<_i23.LoginPageCubit>(() => _i23.LoginPageCubit(
      get<_i21.AuthService>(), get<_i5.PreferencesService>()));
  gh.factory<_i24.RestorePasswordPageCubit>(
      () => _i24.RestorePasswordPageCubit(get<_i21.AuthService>()));
  gh.factory<_i25.AdminBackupsTabCubit>(
      () => _i25.AdminBackupsTabCubit(get<_i22.BackupService>()));
  gh.factory<_i26.AdminClientsTabCubit>(() => _i26.AdminClientsTabCubit(
      get<_i12.ClientsService>(), get<_i21.AuthService>()));
  gh.factoryParam<_i27.AdminEmployeesTabCubit, String?, dynamic>(
      (laundryId, _) => _i27.AdminEmployeesTabCubit(
          get<_i13.LaundriesService>(), get<_i21.AuthService>(), laundryId));
  gh.factory<_i28.AdminLaundriesTabCubit>(() => _i28.AdminLaundriesTabCubit(
      get<_i13.LaundriesService>(), get<_i21.AuthService>()));
  gh.factory<_i29.AdminRepairCompaniesTabCubit>(() =>
      _i29.AdminRepairCompaniesTabCubit(
          get<_i15.RepairCompaniesService>(), get<_i21.AuthService>()));
  gh.factory<_i30.AdminSettingsTabCubit>(
      () => _i30.AdminSettingsTabCubit(get<_i21.AuthService>()));
  return get;
}
