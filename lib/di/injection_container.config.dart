...
import '../bloc/auth/login_page/login_page_cubit.dart' as _i29;
...
import 'module/api_module.dart' as _i37; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i26.EmployeeSettingsTabCubit>(() => _i26.EmployeeSettingsTabCubit(
      get<_i13.LaundriesService>(), get<_i24.AuthService>()));
  gh.factory<_i27.LaundryEmployeeStatisticTabCubit>(() =>
      _i27.LaundryEmployeeStatisticTabCubit(get<_i18.StatisticService>()));
  gh.factory<_i28.LaundrySettingsTabCubit>(() => _i28.LaundrySettingsTabCubit(
      get<_i13.LaundriesService>(), get<_i24.AuthService>()));
  gh.factory<_i29.LoginPageCubit>(() => _i29.LoginPageCubit(
      get<_i24.AuthService>(), get<_i5.PreferencesService>()));
  gh.factory<_i30.RestorePasswordPageCubit>(
      () => _i30.RestorePasswordPageCubit(get<_i24.AuthService>()));
  gh.factory<_i31.AdminBackupsTabCubit>(
      () => _i31.AdminBackupsTabCubit(get<_i25.BackupService>()));
  gh.factory<_i32.AdminClientsTabCubit>(() => _i32.AdminClientsTabCubit(
      get<_i12.ClientsService>(), get<_i24.AuthService>()));
  gh.factoryParam<_i33.AdminEmployeesTabCubit, String?, dynamic>(
      (laundryId, _) => _i33.AdminEmployeesTabCubit(
          get<_i13.LaundriesService>(), get<_i24.AuthService>(), laundryId));
  gh.factory<_i34.AdminLaundriesTabCubit>(() => _i34.AdminLaundriesTabCubit(
      get<_i13.LaundriesService>(), get<_i24.AuthService>()));
  gh.factory<_i35.AdminRepairCompaniesTabCubit>(() =>
      _i35.AdminRepairCompaniesTabCubit(
          get<_i17.RepairCompaniesService>(), get<_i24.AuthService>()));
  gh.factory<_i36.AdminSettingsTabCubit>(
      () => _i36.AdminSettingsTabCubit(get<_i24.AuthService>()));
  return get;
}
