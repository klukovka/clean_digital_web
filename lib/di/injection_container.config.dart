...
import '../api/clean_digital_api_client.dart' as _i8;
...
import 'module/api_module.dart' as _i9; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i6.HeaderApiInterceptor>(
      () => _i6.HeaderApiInterceptor(get<_i5.PreferencesService>()));
  gh.lazySingleton<_i7.Dio>(
      () => apiModule.dio(get<_i6.HeaderApiInterceptor>()));
  gh.lazySingleton<_i8.CleanDigitalApiClient>(
