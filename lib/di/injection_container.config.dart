...
import '../bloc/auth/login_page/login_page_cubit.dart' as _i31;
...
import 'module/api_module.dart' as _i39; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i30.LaundrySettingsTabCubit>(() => _i30.LaundrySettingsTabCubit(
      get<_i13.LaundriesService>(), get<_i25.AuthService>()));
  gh.factory<_i31.LoginPageCubit>(() => _i31.LoginPageCubit(
      get<_i25.AuthService>(), get<_i5.PreferencesService>()));
  gh.factory<_i32.RestorePasswordPageCubit>(
      () => _i32.RestorePasswordPageCubit(get<_i25.AuthService>()));
  gh.factory<_i33.AdminBackupsTabCubit>(
      () => _i33.AdminBackupsTabCubit(get<_i26.BackupService>()));
  gh.factory<_i34.AdminClientsTabCubit>(() => _i34.AdminClientsTabCubit(
      get<_i12.ClientsService>(), get<_i25.AuthService>()));
  gh.factoryParam<_i35.AdminEmployeesTabCubit, String?, dynamic>(
      (laundryId, _) => _i35.AdminEmployeesTabCubit(
          get<_i13.LaundriesService>(), get<_i25.AuthService>(), laundryId));
  gh.factory<_i36.AdminLaundriesTabCubit>(() => _i36.AdminLaundriesTabCubit(
      get<_i13.LaundriesService>(), get<_i25.AuthService>()));
  gh.factory<_i37.AdminRepairCompaniesTabCubit>(() =>
      _i37.AdminRepairCompaniesTabCubit(
          get<_i18.RepairCompaniesService>(), get<_i25.AuthService>()));
  gh.factory<_i38.AdminSettingsTabCubit>(
      () => _i38.AdminSettingsTabCubit(get<_i25.AuthService>()));
  return get;
}
