...
import '../bloc/auth/login_page/login_page_cubit.dart' as _i32;
...
import 'module/api_module.dart' as _i40; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i29.LaundryEmployeeRepairProductsPageCubit>(() =>
      _i29.LaundryEmployeeRepairProductsPageCubit(
          get<_i18.RepairCompaniesService>()));
  gh.factory<_i30.LaundryEmployeeStatisticTabCubit>(() =>
      _i30.LaundryEmployeeStatisticTabCubit(get<_i20.StatisticService>()));
  gh.factory<_i31.LaundrySettingsTabCubit>(() => _i31.LaundrySettingsTabCubit(
      get<_i13.LaundriesService>(), get<_i26.AuthService>()));
  gh.factory<_i32.LoginPageCubit>(() => _i32.LoginPageCubit(
      get<_i26.AuthService>(), get<_i5.PreferencesService>()));
  gh.factory<_i33.RestorePasswordPageCubit>(
      () => _i33.RestorePasswordPageCubit(get<_i26.AuthService>()));
  gh.factory<_i34.AdminBackupsTabCubit>(
      () => _i34.AdminBackupsTabCubit(get<_i27.BackupService>()));
  gh.factory<_i35.AdminClientsTabCubit>(() => _i35.AdminClientsTabCubit(
      get<_i12.ClientsService>(), get<_i26.AuthService>()));
  gh.factoryParam<_i36.AdminEmployeesTabCubit, String?, dynamic>(
      (laundryId, _) => _i36.AdminEmployeesTabCubit(
          get<_i13.LaundriesService>(), get<_i26.AuthService>(), laundryId));
  gh.factory<_i37.AdminLaundriesTabCubit>(() => _i37.AdminLaundriesTabCubit(
      get<_i13.LaundriesService>(), get<_i26.AuthService>()));
  gh.factory<_i38.AdminRepairCompaniesTabCubit>(() =>
      _i38.AdminRepairCompaniesTabCubit(
          get<_i18.RepairCompaniesService>(), get<_i26.AuthService>()));
  gh.factory<_i39.AdminSettingsTabCubit>(
      () => _i39.AdminSettingsTabCubit(get<_i26.AuthService>()));
  return get;
}

class _$ApiModule extends _i40.ApiModule {}
